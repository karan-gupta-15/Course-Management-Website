    ...
    <div class="container-fluid">
        ...
        <div class = "collapse navbar-collapse" id="NavMenu">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><button class="signin-btn"style="margin: 7px"><a href="../loginsystem-files/signup.php">SIGN UP</a></button></li>
                <li><button class="login-btn" style="margin: 7px" ><a href="../loginsystem-files/login.php">LOGIN</a></button></li>
            </ul>
        </div>
    </div>
</nav>
<div class="container-fluid "  style="background-image: linear-gradient(to left bottom, #0066cc, #0095ee, #00beea, #00e2c8, #66ff99)"><br><br>
     ...
     <div class="row">
      ...
      <div class="row">
            ...
            <div class="col-md-2 col-sm-12">
                <img src="../Homeimg/jithin.jpg" class="img-responsive" id="icon">
            </div>
            <div class="col-md-2 col-sm-12" >
...
<footer class="container-fluid text-center">
    <div class="row">
        ...
        <div class="col-sm-4">
            <h3>Connect </h3>
            <a href="https://www.facebook.com/freddy.poly.5" class="fa fa-facebook"></a>
